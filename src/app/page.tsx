  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#C6FC7B' }}>
      ...
      <div className="flex-grow container mx-auto px-4 pt-16 pb-16" style={{ backgroundColor: '#C6FC7B' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mt-16 border-2 rounded-lg rounded-xl border-transparent bg-[#122B1B] p-10">
          {/* Left Box - Smaller */}
          <motion.div 
            className="md:col-span-3 p-6 rounded-xl shadow-md transform hover:translate-y-1 transition-all duration-300 border"
            style={{ backgroundColor: '#6603BF', borderColor: '#C6FC7B' }}
          ...
          {/* Middle Box - Larger */}
          <motion.div 
            className="md:col-span-6 p-8 rounded-xl shadow-lg transform hover:translate-y-1 transition-all duration-300"
        ...
        <motion.div 
          className="mt-24 p-8 rounded-xl"
          style={{ backgroundColor: '#122B1B', marginLeft: '-1rem', marginRight: '-1rem' }}
        ...
        >
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <motion.div 
                className="p-6 rounded-xl shadow-md hover:shadow-lg transition-all border-l-4"
                style={{ backgroundColor: '#7CE8A5', borderColor: '#08130C' }}
                initial={{ opacity: 0, x: -100 }}
                animate={{ opacity: 1, x: 0 }}
              ...
              <motion.div 
                className="p-6 rounded-xl shadow-md hover:shadow-lg transition-all mt-4 md:mt-0 border-l-4"
                style={{ backgroundColor: '#C6FC7B', borderColor: '#122B1B' }}
                initial={{ opacity: 0, x: -100 }}
                animate={{ opacity: 1, x: 0 }}
              ...
              <motion.div 
                className="p-6 rounded-xl shadow-md hover:shadow-lg transition-all mt-4 md:mt-8 border-l-4"
                style={{ backgroundColor: '#ECEFEC', borderColor: '#08130C' }}
                initial={{ opacity: 0, x: -100 }}
                animate={{ opacity: 1, x: 0 }}
              ...
              <motion.div 
                className="p-6 rounded-xl shadow-md hover:shadow-lg transition-all mt-4 md:mt-16 border-l-4"
                style={{ backgroundColor: '#7CE8A5', borderColor: '#08130C' }}
                initial={{ opacity: 0, x: -100 }}
                animate={{ opacity: 1, x: 0 }}
        ...
        {/* Benefits Section */}
        <motion.div 
          className="mt-24 p-10 shadow-xl rounded-xl"
          style={{ backgroundColor: '#6603BF', marginLeft: '-1rem', marginRight: '-1rem' }}
          initial={{ opacity: 0, y: 100 }}
          animate={{ opacity: 1, y: 0 }}
          ...
          <div className="container mx-auto px-4">
            <div className="text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <motion.div 
                  className="p-6 rounded-xl shadow"
                  style={{ backgroundColor: '#7CE8A5' }}
                  initial={{ opacity: 0, y: 50 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.6, delay: 2.2 }}
                  whileHover={{ scale: 1.05, y: -5 }}
                >
                  <h3 className="text-xl font-semibold mb-3" style={{ color: '#08130C' }}>Low Fees</h3>
                  <p style={{ color: '#08130C' }}>Minimize gas costs and trading fees with smart routing</p>
                </motion.div>
                <motion.div 
                  className="p-6 rounded-xl shadow"
                  style={{ backgroundColor: '#ECEFEC' }}
